...
--------------------------------------------------------------*/
  $(".beautifull-spa-and-faeture #first-box").each(function () {
    ...
    $this.appear(function () {
      $(".beautifull-spa-and-faeture #first-box").addClass(
        "animated bounceIn1"
      );
      $(".beautifull-spa-and-faeture #second-box").addClass(
        "animated bounceIn3"
      );
    });
  });
  ...
  $(".beautifull-spa-and-faeture #third-box").each(function () {
    ...
    $this.appear(function () {
      $(".beautifull-spa-and-faeture #third-box").addClass(
        "animated bounceIn3"
      );
      $(".beautifull-spa-and-faeture #fourth-box").addClass(
        "animated bounceIn4"
      );
    });
  });
...
--------------------------------------------------------------*/
  $(
    ".advantages #first-advantage, .advantages #second-advantage, .advantages #third-advantage, .advantages #fourth-advantage"
  ).css({
    opacity: 0,
  });
